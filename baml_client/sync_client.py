...
class BamlSyncClient:
    ...
    def GenererateProbeDataset(self, topic: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="GenererateProbeDataset", args={
                "topic": topic,
            })
...
class BamlStreamClient:
    ...
    def GenererateProbeDataset(self, topic: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Dataset, types.Dataset]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenererateProbeDataset", args={
            "topic": topic,
        })
        return baml_py.BamlSyncStream[stream_types.Dataset, types.Dataset](
          __result__,
